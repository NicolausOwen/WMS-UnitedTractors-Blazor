...
namespace WMS_UnitedTracors_Blazor.Migrations
{
    ...
    [Migration("20260721022352_AddApproversPerStage")]
    partial class AddApproversPerStage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UT_WMSDotnet.Models.Transaction", b =>
                {
                    ...
                    b.Property<int?>("admin_approver_id")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("manager_approver_id")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("staff_inventory_approver_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("admin_approver_id");

                    b.HasIndex("approver_id");

                    b.HasIndex("division_id");

                    b.HasIndex("manager_approver_id");
                    ...
                    b.HasIndex("staff_inventory_approver_id");
            ...
            modelBuilder.Entity("UT_WMSDotnet.Models.Transaction", b =>
                {
                    b.HasOne("UT_WMSDotnet.Models.User", "AdminApprover")
                        .WithMany()
                        .HasForeignKey("admin_approver_id")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("UT_WMSDotnet.Models.User", "ManagerApprover")
                        .WithMany()
                        .HasForeignKey("manager_approver_id")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("UT_WMSDotnet.Models.User", "StaffInventoryApprover")
                        .WithMany()
                        .HasForeignKey("staff_inventory_approver_id")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("StaffInventoryApprover");
                });
